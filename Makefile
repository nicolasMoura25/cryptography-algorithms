...
app: ARIA.o CAMELLIA.o GOST.o HIGHT.o IDEA.o NOEKEON.o PRESENT.o SEED.o SIMON.o SPECK.o main.o
	gcc -Wall -o app ARIA.o CAMELLIA.o GOST.o HIGHT.o IDEA.o NOEKEON.o PRESENT.o SEED.o SIMON.o SPECK.o main.o
